                            ...
                            <form action="" method="post">
                                ...
                                <div class="row col-6">
                                    <div class="form-group col-12">
                                        <label class="control-label">Hạng mục Exam</label>
                                        <input type="text" id="firstName" name="name" class="form-control" placeholder="Exam abc...">
                                    </div>
                                    <div class="form-group col-12">
                                        <label class="control-label">Ghi chú</label>
                                        <textarea class="form-control" name="remark" id="" cols="30" placeholder="Exam bao gồm..." rows="10"></textarea>
                                    </div>
                                </div>
